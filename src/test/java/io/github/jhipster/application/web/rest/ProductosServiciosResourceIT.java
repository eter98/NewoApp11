...
public class ProductosServiciosResourceIT {
     ...
     *
     * @see io.github.jhipster.application.repository.search.ProductosServiciosSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllProductosServiciosByValorIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the productosServiciosList where valor greater than or equals to DEFAULT_VALOR
        defaultProductosServiciosShouldBeFound("valor.greaterOrEqualThan=" + DEFAULT_VALOR);

        // Get all the productosServiciosList where valor greater than or equals to UPDATED_VALOR
        defaultProductosServiciosShouldNotBeFound("valor.greaterOrEqualThan=" + UPDATED_VALOR);
    }
    ...
    public void getAllProductosServiciosByValorIsLessThanSomething() throws Exception {
        ...
        // Get all the productosServiciosList where valor less than or equals to DEFAULT_VALOR
        defaultProductosServiciosShouldNotBeFound("valor.lessThan=" + DEFAULT_VALOR);

        // Get all the productosServiciosList where valor less than or equals to UPDATED_VALOR
