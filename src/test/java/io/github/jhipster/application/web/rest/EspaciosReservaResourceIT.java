...
public class EspaciosReservaResourceIT {
    ...
    public void getAllEspaciosReservasByCapacidadIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espaciosReservaList where capacidad greater than or equals to DEFAULT_CAPACIDAD
        defaultEspaciosReservaShouldBeFound("capacidad.greaterOrEqualThan=" + DEFAULT_CAPACIDAD);

        // Get all the espaciosReservaList where capacidad greater than or equals to UPDATED_CAPACIDAD
        defaultEspaciosReservaShouldNotBeFound("capacidad.greaterOrEqualThan=" + UPDATED_CAPACIDAD);
    }
    ...
    public void getAllEspaciosReservasByCapacidadIsLessThanSomething() throws Exception {
        ...
        // Get all the espaciosReservaList where capacidad less than or equals to DEFAULT_CAPACIDAD
        defaultEspaciosReservaShouldNotBeFound("capacidad.lessThan=" + DEFAULT_CAPACIDAD);

        // Get all the espaciosReservaList where capacidad less than or equals to UPDATED_CAPACIDAD
    ...
    public void getAllEspaciosReservasByTarifa1HoraIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espaciosReservaList where tarifa1Hora greater than or equals to DEFAULT_TARIFA_1_HORA
        defaultEspaciosReservaShouldBeFound("tarifa1Hora.greaterOrEqualThan=" + DEFAULT_TARIFA_1_HORA);

        // Get all the espaciosReservaList where tarifa1Hora greater than or equals to UPDATED_TARIFA_1_HORA
        defaultEspaciosReservaShouldNotBeFound("tarifa1Hora.greaterOrEqualThan=" + UPDATED_TARIFA_1_HORA);
    }
    ...
    public void getAllEspaciosReservasByTarifa1HoraIsLessThanSomething() throws Exception {
        ...
        // Get all the espaciosReservaList where tarifa1Hora less than or equals to DEFAULT_TARIFA_1_HORA
        defaultEspaciosReservaShouldNotBeFound("tarifa1Hora.lessThan=" + DEFAULT_TARIFA_1_HORA);

        // Get all the espaciosReservaList where tarifa1Hora less than or equals to UPDATED_TARIFA_1_HORA
    ...
    public void getAllEspaciosReservasByTarifa2HoraIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espaciosReservaList where tarifa2Hora greater than or equals to DEFAULT_TARIFA_2_HORA
        defaultEspaciosReservaShouldBeFound("tarifa2Hora.greaterOrEqualThan=" + DEFAULT_TARIFA_2_HORA);

        // Get all the espaciosReservaList where tarifa2Hora greater than or equals to UPDATED_TARIFA_2_HORA
        defaultEspaciosReservaShouldNotBeFound("tarifa2Hora.greaterOrEqualThan=" + UPDATED_TARIFA_2_HORA);
    }
    ...
    public void getAllEspaciosReservasByTarifa2HoraIsLessThanSomething() throws Exception {
        ...
        // Get all the espaciosReservaList where tarifa2Hora less than or equals to DEFAULT_TARIFA_2_HORA
        defaultEspaciosReservaShouldNotBeFound("tarifa2Hora.lessThan=" + DEFAULT_TARIFA_2_HORA);

        // Get all the espaciosReservaList where tarifa2Hora less than or equals to UPDATED_TARIFA_2_HORA
    ...
    public void getAllEspaciosReservasByTarifa3HoraIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espaciosReservaList where tarifa3Hora greater than or equals to DEFAULT_TARIFA_3_HORA
        defaultEspaciosReservaShouldBeFound("tarifa3Hora.greaterOrEqualThan=" + DEFAULT_TARIFA_3_HORA);

        // Get all the espaciosReservaList where tarifa3Hora greater than or equals to UPDATED_TARIFA_3_HORA
        defaultEspaciosReservaShouldNotBeFound("tarifa3Hora.greaterOrEqualThan=" + UPDATED_TARIFA_3_HORA);
    }
    ...
    public void getAllEspaciosReservasByTarifa3HoraIsLessThanSomething() throws Exception {
        ...
        // Get all the espaciosReservaList where tarifa3Hora less than or equals to DEFAULT_TARIFA_3_HORA
        defaultEspaciosReservaShouldNotBeFound("tarifa3Hora.lessThan=" + DEFAULT_TARIFA_3_HORA);

        // Get all the espaciosReservaList where tarifa3Hora less than or equals to UPDATED_TARIFA_3_HORA
    ...
    public void getAllEspaciosReservasByTarifa4HoraIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espaciosReservaList where tarifa4Hora greater than or equals to DEFAULT_TARIFA_4_HORA
        defaultEspaciosReservaShouldBeFound("tarifa4Hora.greaterOrEqualThan=" + DEFAULT_TARIFA_4_HORA);

        // Get all the espaciosReservaList where tarifa4Hora greater than or equals to UPDATED_TARIFA_4_HORA
        defaultEspaciosReservaShouldNotBeFound("tarifa4Hora.greaterOrEqualThan=" + UPDATED_TARIFA_4_HORA);
    }
    ...
    public void getAllEspaciosReservasByTarifa4HoraIsLessThanSomething() throws Exception {
        ...
        // Get all the espaciosReservaList where tarifa4Hora less than or equals to DEFAULT_TARIFA_4_HORA
        defaultEspaciosReservaShouldNotBeFound("tarifa4Hora.lessThan=" + DEFAULT_TARIFA_4_HORA);

        // Get all the espaciosReservaList where tarifa4Hora less than or equals to UPDATED_TARIFA_4_HORA
    ...
    public void getAllEspaciosReservasByTarifa5HoraIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espaciosReservaList where tarifa5Hora greater than or equals to DEFAULT_TARIFA_5_HORA
        defaultEspaciosReservaShouldBeFound("tarifa5Hora.greaterOrEqualThan=" + DEFAULT_TARIFA_5_HORA);

        // Get all the espaciosReservaList where tarifa5Hora greater than or equals to UPDATED_TARIFA_5_HORA
        defaultEspaciosReservaShouldNotBeFound("tarifa5Hora.greaterOrEqualThan=" + UPDATED_TARIFA_5_HORA);
    }
    ...
    public void getAllEspaciosReservasByTarifa5HoraIsLessThanSomething() throws Exception {
        ...
        // Get all the espaciosReservaList where tarifa5Hora less than or equals to DEFAULT_TARIFA_5_HORA
        defaultEspaciosReservaShouldNotBeFound("tarifa5Hora.lessThan=" + DEFAULT_TARIFA_5_HORA);

        // Get all the espaciosReservaList where tarifa5Hora less than or equals to UPDATED_TARIFA_5_HORA
    ...
    public void getAllEspaciosReservasByTarifa6HoraIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espaciosReservaList where tarifa6Hora greater than or equals to DEFAULT_TARIFA_6_HORA
        defaultEspaciosReservaShouldBeFound("tarifa6Hora.greaterOrEqualThan=" + DEFAULT_TARIFA_6_HORA);

        // Get all the espaciosReservaList where tarifa6Hora greater than or equals to UPDATED_TARIFA_6_HORA
        defaultEspaciosReservaShouldNotBeFound("tarifa6Hora.greaterOrEqualThan=" + UPDATED_TARIFA_6_HORA);
    }
    ...
    public void getAllEspaciosReservasByTarifa6HoraIsLessThanSomething() throws Exception {
        ...
        // Get all the espaciosReservaList where tarifa6Hora less than or equals to DEFAULT_TARIFA_6_HORA
        defaultEspaciosReservaShouldNotBeFound("tarifa6Hora.lessThan=" + DEFAULT_TARIFA_6_HORA);

        // Get all the espaciosReservaList where tarifa6Hora less than or equals to UPDATED_TARIFA_6_HORA
    ...
    public void getAllEspaciosReservasByTarifa7HoraIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espaciosReservaList where tarifa7Hora greater than or equals to DEFAULT_TARIFA_7_HORA
        defaultEspaciosReservaShouldBeFound("tarifa7Hora.greaterOrEqualThan=" + DEFAULT_TARIFA_7_HORA);

        // Get all the espaciosReservaList where tarifa7Hora greater than or equals to UPDATED_TARIFA_7_HORA
        defaultEspaciosReservaShouldNotBeFound("tarifa7Hora.greaterOrEqualThan=" + UPDATED_TARIFA_7_HORA);
    }
    ...
    public void getAllEspaciosReservasByTarifa7HoraIsLessThanSomething() throws Exception {
        ...
        // Get all the espaciosReservaList where tarifa7Hora less than or equals to DEFAULT_TARIFA_7_HORA
        defaultEspaciosReservaShouldNotBeFound("tarifa7Hora.lessThan=" + DEFAULT_TARIFA_7_HORA);

        // Get all the espaciosReservaList where tarifa7Hora less than or equals to UPDATED_TARIFA_7_HORA
    ...
    public void getAllEspaciosReservasByTarifa8HoraIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espaciosReservaList where tarifa8Hora greater than or equals to DEFAULT_TARIFA_8_HORA
        defaultEspaciosReservaShouldBeFound("tarifa8Hora.greaterOrEqualThan=" + DEFAULT_TARIFA_8_HORA);

        // Get all the espaciosReservaList where tarifa8Hora greater than or equals to UPDATED_TARIFA_8_HORA
        defaultEspaciosReservaShouldNotBeFound("tarifa8Hora.greaterOrEqualThan=" + UPDATED_TARIFA_8_HORA);
    }
    ...
    public void getAllEspaciosReservasByTarifa8HoraIsLessThanSomething() throws Exception {
        ...
        // Get all the espaciosReservaList where tarifa8Hora less than or equals to DEFAULT_TARIFA_8_HORA
        defaultEspaciosReservaShouldNotBeFound("tarifa8Hora.lessThan=" + DEFAULT_TARIFA_8_HORA);

        // Get all the espaciosReservaList where tarifa8Hora less than or equals to UPDATED_TARIFA_8_HORA
