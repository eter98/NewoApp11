...
public class BeneficioResourceIT {
     ...
     *
     * @see io.github.jhipster.application.repository.search.BeneficioSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllBeneficiosByDescuentoIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the beneficioList where descuento greater than or equals to DEFAULT_DESCUENTO
        defaultBeneficioShouldBeFound("descuento.greaterOrEqualThan=" + DEFAULT_DESCUENTO);

        // Get all the beneficioList where descuento greater than or equals to UPDATED_DESCUENTO
        defaultBeneficioShouldNotBeFound("descuento.greaterOrEqualThan=" + UPDATED_DESCUENTO);
    }
    ...
    public void getAllBeneficiosByDescuentoIsLessThanSomething() throws Exception {
        ...
        // Get all the beneficioList where descuento less than or equals to DEFAULT_DESCUENTO
        defaultBeneficioShouldNotBeFound("descuento.lessThan=" + DEFAULT_DESCUENTO);

        // Get all the beneficioList where descuento less than or equals to UPDATED_DESCUENTO
