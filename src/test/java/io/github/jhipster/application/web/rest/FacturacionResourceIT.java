...
public class FacturacionResourceIT {
    ...
    public void getAllFacturacionsByValorIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the facturacionList where valor greater than or equals to DEFAULT_VALOR
        defaultFacturacionShouldBeFound("valor.greaterOrEqualThan=" + DEFAULT_VALOR);

        // Get all the facturacionList where valor greater than or equals to UPDATED_VALOR
        defaultFacturacionShouldNotBeFound("valor.greaterOrEqualThan=" + UPDATED_VALOR);
    }
    ...
    public void getAllFacturacionsByValorIsLessThanSomething() throws Exception {
        ...
        // Get all the facturacionList where valor less than or equals to DEFAULT_VALOR
        defaultFacturacionShouldNotBeFound("valor.lessThan=" + DEFAULT_VALOR);

        // Get all the facturacionList where valor less than or equals to UPDATED_VALOR
