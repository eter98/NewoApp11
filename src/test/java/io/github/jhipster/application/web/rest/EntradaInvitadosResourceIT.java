...
public class EntradaInvitadosResourceIT {
    ...
    public void getAllEntradaInvitadosByRegistroFechaIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the entradaInvitadosList where registroFecha greater than or equals to DEFAULT_REGISTRO_FECHA
        defaultEntradaInvitadosShouldBeFound("registroFecha.greaterOrEqualThan=" + DEFAULT_REGISTRO_FECHA);

        // Get all the entradaInvitadosList where registroFecha greater than or equals to UPDATED_REGISTRO_FECHA
        defaultEntradaInvitadosShouldNotBeFound("registroFecha.greaterOrEqualThan=" + UPDATED_REGISTRO_FECHA);
    }
    ...
    public void getAllEntradaInvitadosByRegistroFechaIsLessThanSomething() throws Exception {
        ...
        // Get all the entradaInvitadosList where registroFecha less than or equals to DEFAULT_REGISTRO_FECHA
        defaultEntradaInvitadosShouldNotBeFound("registroFecha.lessThan=" + DEFAULT_REGISTRO_FECHA);

        // Get all the entradaInvitadosList where registroFecha less than or equals to UPDATED_REGISTRO_FECHA
    ...
    @Test
    @Transactional
    public void getAllEntradaInvitadosByRegistroCompraIsEqualToSomething() throws Exception {
        // Initialize the database
        RegistroCompra registroCompra = RegistroCompraResourceIT.createEntity(em);
        em.persist(registroCompra);
        em.flush();
        entradaInvitados.addRegistroCompra(registroCompra);
        entradaInvitadosRepository.saveAndFlush(entradaInvitados);
        Long registroCompraId = registroCompra.getId();

        // Get all the entradaInvitadosList where registroCompra equals to registroCompraId
        defaultEntradaInvitadosShouldBeFound("registroCompraId.equals=" + registroCompraId);

        // Get all the entradaInvitadosList where registroCompra equals to registroCompraId + 1
        defaultEntradaInvitadosShouldNotBeFound("registroCompraId.equals=" + (registroCompraId + 1));
    }
