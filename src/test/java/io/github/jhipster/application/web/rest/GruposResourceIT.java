...
public class GruposResourceIT {
     ...
     *
     * @see io.github.jhipster.application.repository.search.GruposSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllGruposByValorSuscripcionIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the gruposList where valorSuscripcion greater than or equals to DEFAULT_VALOR_SUSCRIPCION
        defaultGruposShouldBeFound("valorSuscripcion.greaterOrEqualThan=" + DEFAULT_VALOR_SUSCRIPCION);

        // Get all the gruposList where valorSuscripcion greater than or equals to UPDATED_VALOR_SUSCRIPCION
        defaultGruposShouldNotBeFound("valorSuscripcion.greaterOrEqualThan=" + UPDATED_VALOR_SUSCRIPCION);
    }
    ...
    public void getAllGruposByValorSuscripcionIsLessThanSomething() throws Exception {
        ...
        // Get all the gruposList where valorSuscripcion less than or equals to DEFAULT_VALOR_SUSCRIPCION
        defaultGruposShouldNotBeFound("valorSuscripcion.lessThan=" + DEFAULT_VALOR_SUSCRIPCION);

        // Get all the gruposList where valorSuscripcion less than or equals to UPDATED_VALOR_SUSCRIPCION
    ...
    @Test
    @Transactional
    public void getAllGruposByEventoIsEqualToSomething() throws Exception {
        // Initialize the database
        Evento evento = EventoResourceIT.createEntity(em);
        em.persist(evento);
        em.flush();
        grupos.setEvento(evento);
        gruposRepository.saveAndFlush(grupos);
        Long eventoId = evento.getId();

        // Get all the gruposList where evento equals to eventoId
        defaultGruposShouldBeFound("eventoId.equals=" + eventoId);

        // Get all the gruposList where evento equals to eventoId + 1
        defaultGruposShouldNotBeFound("eventoId.equals=" + (eventoId + 1));
    }
