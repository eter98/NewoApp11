...
public class TipoPrepagoConsumoResourceIT {
     ...
     *
     * @see io.github.jhipster.application.repository.search.TipoPrepagoConsumoSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllTipoPrepagoConsumosByValorMinimoIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the tipoPrepagoConsumoList where valorMinimo greater than or equals to DEFAULT_VALOR_MINIMO
        defaultTipoPrepagoConsumoShouldBeFound("valorMinimo.greaterOrEqualThan=" + DEFAULT_VALOR_MINIMO);

        // Get all the tipoPrepagoConsumoList where valorMinimo greater than or equals to UPDATED_VALOR_MINIMO
        defaultTipoPrepagoConsumoShouldNotBeFound("valorMinimo.greaterOrEqualThan=" + UPDATED_VALOR_MINIMO);
    }
    ...
    public void getAllTipoPrepagoConsumosByValorMinimoIsLessThanSomething() throws Exception {
        ...
        // Get all the tipoPrepagoConsumoList where valorMinimo less than or equals to DEFAULT_VALOR_MINIMO
        defaultTipoPrepagoConsumoShouldNotBeFound("valorMinimo.lessThan=" + DEFAULT_VALOR_MINIMO);

        // Get all the tipoPrepagoConsumoList where valorMinimo less than or equals to UPDATED_VALOR_MINIMO
    ...
    public void getAllTipoPrepagoConsumosByValorMaximoIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the tipoPrepagoConsumoList where valorMaximo greater than or equals to DEFAULT_VALOR_MAXIMO
        defaultTipoPrepagoConsumoShouldBeFound("valorMaximo.greaterOrEqualThan=" + DEFAULT_VALOR_MAXIMO);

        // Get all the tipoPrepagoConsumoList where valorMaximo greater than or equals to UPDATED_VALOR_MAXIMO
        defaultTipoPrepagoConsumoShouldNotBeFound("valorMaximo.greaterOrEqualThan=" + UPDATED_VALOR_MAXIMO);
    }
    ...
    public void getAllTipoPrepagoConsumosByValorMaximoIsLessThanSomething() throws Exception {
        ...
        // Get all the tipoPrepagoConsumoList where valorMaximo less than or equals to DEFAULT_VALOR_MAXIMO
        defaultTipoPrepagoConsumoShouldNotBeFound("valorMaximo.lessThan=" + DEFAULT_VALOR_MAXIMO);

        // Get all the tipoPrepagoConsumoList where valorMaximo less than or equals to UPDATED_VALOR_MAXIMO
