...
public class ReservasResourceIT {
    ...
    private static final EstadoReservad DEFAULT_ESTADO_RESERVA = EstadoReservad.Disponible;
     ...
     *
     * @see io.github.jhipster.application.repository.search.ReservasSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllReservasByRegistroFechaEntradaIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the reservasList where registroFechaEntrada greater than or equals to DEFAULT_REGISTRO_FECHA_ENTRADA
        defaultReservasShouldBeFound("registroFechaEntrada.greaterOrEqualThan=" + DEFAULT_REGISTRO_FECHA_ENTRADA);

        // Get all the reservasList where registroFechaEntrada greater than or equals to UPDATED_REGISTRO_FECHA_ENTRADA
        defaultReservasShouldNotBeFound("registroFechaEntrada.greaterOrEqualThan=" + UPDATED_REGISTRO_FECHA_ENTRADA);
    }
    ...
    public void getAllReservasByRegistroFechaEntradaIsLessThanSomething() throws Exception {
        ...
        // Get all the reservasList where registroFechaEntrada less than or equals to DEFAULT_REGISTRO_FECHA_ENTRADA
        defaultReservasShouldNotBeFound("registroFechaEntrada.lessThan=" + DEFAULT_REGISTRO_FECHA_ENTRADA);

        // Get all the reservasList where registroFechaEntrada less than or equals to UPDATED_REGISTRO_FECHA_ENTRADA
    ...
    public void getAllReservasByRegistroFechaSalidaIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the reservasList where registroFechaSalida greater than or equals to DEFAULT_REGISTRO_FECHA_SALIDA
        defaultReservasShouldBeFound("registroFechaSalida.greaterOrEqualThan=" + DEFAULT_REGISTRO_FECHA_SALIDA);

        // Get all the reservasList where registroFechaSalida greater than or equals to UPDATED_REGISTRO_FECHA_SALIDA
        defaultReservasShouldNotBeFound("registroFechaSalida.greaterOrEqualThan=" + UPDATED_REGISTRO_FECHA_SALIDA);
    }
    ...
    public void getAllReservasByRegistroFechaSalidaIsLessThanSomething() throws Exception {
        ...
        // Get all the reservasList where registroFechaSalida less than or equals to DEFAULT_REGISTRO_FECHA_SALIDA
        defaultReservasShouldNotBeFound("registroFechaSalida.lessThan=" + DEFAULT_REGISTRO_FECHA_SALIDA);

        // Get all the reservasList where registroFechaSalida less than or equals to UPDATED_REGISTRO_FECHA_SALIDA
    ...
    @Test
    @Transactional
    public void getAllReservasByRegistroCompraIsEqualToSomething() throws Exception {
        // Initialize the database
        RegistroCompra registroCompra = RegistroCompraResourceIT.createEntity(em);
        em.persist(registroCompra);
        em.flush();
        reservas.addRegistroCompra(registroCompra);
        reservasRepository.saveAndFlush(reservas);
        Long registroCompraId = registroCompra.getId();

        // Get all the reservasList where registroCompra equals to registroCompraId
        defaultReservasShouldBeFound("registroCompraId.equals=" + registroCompraId);

        // Get all the reservasList where registroCompra equals to registroCompraId + 1
        defaultReservasShouldNotBeFound("registroCompraId.equals=" + (registroCompraId + 1));
    }
