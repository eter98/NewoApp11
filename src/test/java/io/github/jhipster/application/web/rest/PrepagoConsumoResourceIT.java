...
public class PrepagoConsumoResourceIT {
     ...
     *
     * @see io.github.jhipster.application.repository.search.PrepagoConsumoSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllPrepagoConsumosByAporteIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the prepagoConsumoList where aporte greater than or equals to DEFAULT_APORTE
        defaultPrepagoConsumoShouldBeFound("aporte.greaterOrEqualThan=" + DEFAULT_APORTE);

        // Get all the prepagoConsumoList where aporte greater than or equals to UPDATED_APORTE
        defaultPrepagoConsumoShouldNotBeFound("aporte.greaterOrEqualThan=" + UPDATED_APORTE);
    }
    ...
    public void getAllPrepagoConsumosByAporteIsLessThanSomething() throws Exception {
        ...
        // Get all the prepagoConsumoList where aporte less than or equals to DEFAULT_APORTE
        defaultPrepagoConsumoShouldNotBeFound("aporte.lessThan=" + DEFAULT_APORTE);

        // Get all the prepagoConsumoList where aporte less than or equals to UPDATED_APORTE
    ...
    public void getAllPrepagoConsumosBySaldoActualIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the prepagoConsumoList where saldoActual greater than or equals to DEFAULT_SALDO_ACTUAL
        defaultPrepagoConsumoShouldBeFound("saldoActual.greaterOrEqualThan=" + DEFAULT_SALDO_ACTUAL);

        // Get all the prepagoConsumoList where saldoActual greater than or equals to UPDATED_SALDO_ACTUAL
        defaultPrepagoConsumoShouldNotBeFound("saldoActual.greaterOrEqualThan=" + UPDATED_SALDO_ACTUAL);
    }
    ...
    public void getAllPrepagoConsumosBySaldoActualIsLessThanSomething() throws Exception {
        ...
        // Get all the prepagoConsumoList where saldoActual less than or equals to DEFAULT_SALDO_ACTUAL
        defaultPrepagoConsumoShouldNotBeFound("saldoActual.lessThan=" + DEFAULT_SALDO_ACTUAL);

        // Get all the prepagoConsumoList where saldoActual less than or equals to UPDATED_SALDO_ACTUAL
    ...
    public void getAllPrepagoConsumosByFechaRegistroIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the prepagoConsumoList where fechaRegistro greater than or equals to DEFAULT_FECHA_REGISTRO
        defaultPrepagoConsumoShouldBeFound("fechaRegistro.greaterOrEqualThan=" + DEFAULT_FECHA_REGISTRO);

        // Get all the prepagoConsumoList where fechaRegistro greater than or equals to UPDATED_FECHA_REGISTRO
        defaultPrepagoConsumoShouldNotBeFound("fechaRegistro.greaterOrEqualThan=" + UPDATED_FECHA_REGISTRO);
    }
    ...
    public void getAllPrepagoConsumosByFechaRegistroIsLessThanSomething() throws Exception {
        ...
        // Get all the prepagoConsumoList where fechaRegistro less than or equals to DEFAULT_FECHA_REGISTRO
        defaultPrepagoConsumoShouldNotBeFound("fechaRegistro.lessThan=" + DEFAULT_FECHA_REGISTRO);

        // Get all the prepagoConsumoList where fechaRegistro less than or equals to UPDATED_FECHA_REGISTRO
    ...
    public void getAllPrepagoConsumosByFechaSaldoActualIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the prepagoConsumoList where fechaSaldoActual greater than or equals to DEFAULT_FECHA_SALDO_ACTUAL
        defaultPrepagoConsumoShouldBeFound("fechaSaldoActual.greaterOrEqualThan=" + DEFAULT_FECHA_SALDO_ACTUAL);

        // Get all the prepagoConsumoList where fechaSaldoActual greater than or equals to UPDATED_FECHA_SALDO_ACTUAL
        defaultPrepagoConsumoShouldNotBeFound("fechaSaldoActual.greaterOrEqualThan=" + UPDATED_FECHA_SALDO_ACTUAL);
    }
    ...
    public void getAllPrepagoConsumosByFechaSaldoActualIsLessThanSomething() throws Exception {
        ...
        // Get all the prepagoConsumoList where fechaSaldoActual less than or equals to DEFAULT_FECHA_SALDO_ACTUAL
        defaultPrepagoConsumoShouldNotBeFound("fechaSaldoActual.lessThan=" + DEFAULT_FECHA_SALDO_ACTUAL);

        // Get all the prepagoConsumoList where fechaSaldoActual less than or equals to UPDATED_FECHA_SALDO_ACTUAL
