...
import io.github.jhipster.application.repository.search.BlogSearchRepository;
import io.github.jhipster.application.service.BlogService;
import io.github.jhipster.application.web.rest.errors.ExceptionTranslator;
import io.github.jhipster.application.service.dto.BlogCriteria;
import io.github.jhipster.application.service.BlogQueryService;
...
public class BlogResourceIT {
     ...
     *
     * @see io.github.jhipster.application.repository.search.BlogSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    @Test
    @Transactional
    public void getAllBlogsByFechaIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        blogRepository.saveAndFlush(blog);

        // Get all the blogList where fecha greater than or equals to DEFAULT_FECHA
        defaultBlogShouldBeFound("fecha.greaterOrEqualThan=" + DEFAULT_FECHA);

        // Get all the blogList where fecha greater than or equals to UPDATED_FECHA
        defaultBlogShouldNotBeFound("fecha.greaterOrEqualThan=" + UPDATED_FECHA);
    }

    @Test
    @Transactional
    public void getAllBlogsByFechaIsLessThanSomething() throws Exception {
        // Initialize the database
        blogRepository.saveAndFlush(blog);

        // Get all the blogList where fecha less than or equals to DEFAULT_FECHA
        defaultBlogShouldNotBeFound("fecha.lessThan=" + DEFAULT_FECHA);

        // Get all the blogList where fecha less than or equals to UPDATED_FECHA
        defaultBlogShouldBeFound("fecha.lessThan=" + UPDATED_FECHA);
    }
