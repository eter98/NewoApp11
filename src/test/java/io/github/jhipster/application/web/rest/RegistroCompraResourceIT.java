...
public class RegistroCompraResourceIT {
    ...
    public void getAllRegistroComprasByValorIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the registroCompraList where valor greater than or equals to DEFAULT_VALOR
        defaultRegistroCompraShouldBeFound("valor.greaterOrEqualThan=" + DEFAULT_VALOR);

        // Get all the registroCompraList where valor greater than or equals to UPDATED_VALOR
        defaultRegistroCompraShouldNotBeFound("valor.greaterOrEqualThan=" + UPDATED_VALOR);
    }
    ...
    public void getAllRegistroComprasByValorIsLessThanSomething() throws Exception {
        ...
        // Get all the registroCompraList where valor less than or equals to DEFAULT_VALOR
        defaultRegistroCompraShouldNotBeFound("valor.lessThan=" + DEFAULT_VALOR);

        // Get all the registroCompraList where valor less than or equals to UPDATED_VALOR
