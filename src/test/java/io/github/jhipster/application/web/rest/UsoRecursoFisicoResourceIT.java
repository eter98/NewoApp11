...
public class UsoRecursoFisicoResourceIT {
     ...
     *
     * @see io.github.jhipster.application.repository.search.UsoRecursoFisicoSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllUsoRecursoFisicosByRegistroFechaInicioIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the usoRecursoFisicoList where registroFechaInicio greater than or equals to DEFAULT_REGISTRO_FECHA_INICIO
        defaultUsoRecursoFisicoShouldBeFound("registroFechaInicio.greaterOrEqualThan=" + DEFAULT_REGISTRO_FECHA_INICIO);

        // Get all the usoRecursoFisicoList where registroFechaInicio greater than or equals to UPDATED_REGISTRO_FECHA_INICIO
        defaultUsoRecursoFisicoShouldNotBeFound("registroFechaInicio.greaterOrEqualThan=" + UPDATED_REGISTRO_FECHA_INICIO);
    }
    ...
    public void getAllUsoRecursoFisicosByRegistroFechaInicioIsLessThanSomething() throws Exception {
        ...
        // Get all the usoRecursoFisicoList where registroFechaInicio less than or equals to DEFAULT_REGISTRO_FECHA_INICIO
        defaultUsoRecursoFisicoShouldNotBeFound("registroFechaInicio.lessThan=" + DEFAULT_REGISTRO_FECHA_INICIO);

        // Get all the usoRecursoFisicoList where registroFechaInicio less than or equals to UPDATED_REGISTRO_FECHA_INICIO
    ...
    public void getAllUsoRecursoFisicosByRegistroFechaFinalIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the usoRecursoFisicoList where registroFechaFinal greater than or equals to DEFAULT_REGISTRO_FECHA_FINAL
        defaultUsoRecursoFisicoShouldBeFound("registroFechaFinal.greaterOrEqualThan=" + DEFAULT_REGISTRO_FECHA_FINAL);

        // Get all the usoRecursoFisicoList where registroFechaFinal greater than or equals to UPDATED_REGISTRO_FECHA_FINAL
        defaultUsoRecursoFisicoShouldNotBeFound("registroFechaFinal.greaterOrEqualThan=" + UPDATED_REGISTRO_FECHA_FINAL);
    }
    ...
    public void getAllUsoRecursoFisicosByRegistroFechaFinalIsLessThanSomething() throws Exception {
        ...
        // Get all the usoRecursoFisicoList where registroFechaFinal less than or equals to DEFAULT_REGISTRO_FECHA_FINAL
        defaultUsoRecursoFisicoShouldNotBeFound("registroFechaFinal.lessThan=" + DEFAULT_REGISTRO_FECHA_FINAL);

        // Get all the usoRecursoFisicoList where registroFechaFinal less than or equals to UPDATED_REGISTRO_FECHA_FINAL
