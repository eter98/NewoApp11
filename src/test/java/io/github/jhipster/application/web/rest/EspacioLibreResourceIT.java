...
import io.github.jhipster.application.NewoApp11App;
 ...
 */
@SpringBootTest(classes = NewoApp11App.class)
public class EspacioLibreResourceIT {
     ...
     *
     * @see io.github.jhipster.application.repository.search.EspacioLibreSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllEspacioLibresByCapacidadInstaladaIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espacioLibreList where capacidadInstalada greater than or equals to DEFAULT_CAPACIDAD_INSTALADA
        defaultEspacioLibreShouldBeFound("capacidadInstalada.greaterOrEqualThan=" + DEFAULT_CAPACIDAD_INSTALADA);

        // Get all the espacioLibreList where capacidadInstalada greater than or equals to UPDATED_CAPACIDAD_INSTALADA
        defaultEspacioLibreShouldNotBeFound("capacidadInstalada.greaterOrEqualThan=" + UPDATED_CAPACIDAD_INSTALADA);
    }
    ...
    public void getAllEspacioLibresByCapacidadInstaladaIsLessThanSomething() throws Exception {
        ...
        // Get all the espacioLibreList where capacidadInstalada less than or equals to DEFAULT_CAPACIDAD_INSTALADA
        defaultEspacioLibreShouldNotBeFound("capacidadInstalada.lessThan=" + DEFAULT_CAPACIDAD_INSTALADA);

        // Get all the espacioLibreList where capacidadInstalada less than or equals to UPDATED_CAPACIDAD_INSTALADA
    ...
    public void getAllEspacioLibresByTarifa1hMiembroIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa1hMiembro greater than or equals to DEFAULT_TARIFA_1_H_MIEMBRO
        defaultEspacioLibreShouldBeFound("tarifa1hMiembro.greaterOrEqualThan=" + DEFAULT_TARIFA_1_H_MIEMBRO);

        // Get all the espacioLibreList where tarifa1hMiembro greater than or equals to UPDATED_TARIFA_1_H_MIEMBRO
        defaultEspacioLibreShouldNotBeFound("tarifa1hMiembro.greaterOrEqualThan=" + UPDATED_TARIFA_1_H_MIEMBRO);
    }
    ...
    public void getAllEspacioLibresByTarifa1hMiembroIsLessThanSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa1hMiembro less than or equals to DEFAULT_TARIFA_1_H_MIEMBRO
        defaultEspacioLibreShouldNotBeFound("tarifa1hMiembro.lessThan=" + DEFAULT_TARIFA_1_H_MIEMBRO);

        // Get all the espacioLibreList where tarifa1hMiembro less than or equals to UPDATED_TARIFA_1_H_MIEMBRO
    ...
    public void getAllEspacioLibresByTarifa2hMiembroIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa2hMiembro greater than or equals to DEFAULT_TARIFA_2_H_MIEMBRO
        defaultEspacioLibreShouldBeFound("tarifa2hMiembro.greaterOrEqualThan=" + DEFAULT_TARIFA_2_H_MIEMBRO);

        // Get all the espacioLibreList where tarifa2hMiembro greater than or equals to UPDATED_TARIFA_2_H_MIEMBRO
        defaultEspacioLibreShouldNotBeFound("tarifa2hMiembro.greaterOrEqualThan=" + UPDATED_TARIFA_2_H_MIEMBRO);
    }
    ...
    public void getAllEspacioLibresByTarifa2hMiembroIsLessThanSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa2hMiembro less than or equals to DEFAULT_TARIFA_2_H_MIEMBRO
        defaultEspacioLibreShouldNotBeFound("tarifa2hMiembro.lessThan=" + DEFAULT_TARIFA_2_H_MIEMBRO);

        // Get all the espacioLibreList where tarifa2hMiembro less than or equals to UPDATED_TARIFA_2_H_MIEMBRO
    ...
    public void getAllEspacioLibresByTarifa3hMiembroIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa3hMiembro greater than or equals to DEFAULT_TARIFA_3_H_MIEMBRO
        defaultEspacioLibreShouldBeFound("tarifa3hMiembro.greaterOrEqualThan=" + DEFAULT_TARIFA_3_H_MIEMBRO);

        // Get all the espacioLibreList where tarifa3hMiembro greater than or equals to UPDATED_TARIFA_3_H_MIEMBRO
        defaultEspacioLibreShouldNotBeFound("tarifa3hMiembro.greaterOrEqualThan=" + UPDATED_TARIFA_3_H_MIEMBRO);
    }
    ...
    public void getAllEspacioLibresByTarifa3hMiembroIsLessThanSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa3hMiembro less than or equals to DEFAULT_TARIFA_3_H_MIEMBRO
        defaultEspacioLibreShouldNotBeFound("tarifa3hMiembro.lessThan=" + DEFAULT_TARIFA_3_H_MIEMBRO);

        // Get all the espacioLibreList where tarifa3hMiembro less than or equals to UPDATED_TARIFA_3_H_MIEMBRO
    ...
    public void getAllEspacioLibresByTarifa4hMiembroIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa4hMiembro greater than or equals to DEFAULT_TARIFA_4_H_MIEMBRO
        defaultEspacioLibreShouldBeFound("tarifa4hMiembro.greaterOrEqualThan=" + DEFAULT_TARIFA_4_H_MIEMBRO);

        // Get all the espacioLibreList where tarifa4hMiembro greater than or equals to UPDATED_TARIFA_4_H_MIEMBRO
        defaultEspacioLibreShouldNotBeFound("tarifa4hMiembro.greaterOrEqualThan=" + UPDATED_TARIFA_4_H_MIEMBRO);
    }
    ...
    public void getAllEspacioLibresByTarifa4hMiembroIsLessThanSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa4hMiembro less than or equals to DEFAULT_TARIFA_4_H_MIEMBRO
        defaultEspacioLibreShouldNotBeFound("tarifa4hMiembro.lessThan=" + DEFAULT_TARIFA_4_H_MIEMBRO);

        // Get all the espacioLibreList where tarifa4hMiembro less than or equals to UPDATED_TARIFA_4_H_MIEMBRO
    ...
    public void getAllEspacioLibresByTarifa5hMiembroIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa5hMiembro greater than or equals to DEFAULT_TARIFA_5_H_MIEMBRO
        defaultEspacioLibreShouldBeFound("tarifa5hMiembro.greaterOrEqualThan=" + DEFAULT_TARIFA_5_H_MIEMBRO);

        // Get all the espacioLibreList where tarifa5hMiembro greater than or equals to UPDATED_TARIFA_5_H_MIEMBRO
        defaultEspacioLibreShouldNotBeFound("tarifa5hMiembro.greaterOrEqualThan=" + UPDATED_TARIFA_5_H_MIEMBRO);
    }
    ...
    public void getAllEspacioLibresByTarifa5hMiembroIsLessThanSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa5hMiembro less than or equals to DEFAULT_TARIFA_5_H_MIEMBRO
        defaultEspacioLibreShouldNotBeFound("tarifa5hMiembro.lessThan=" + DEFAULT_TARIFA_5_H_MIEMBRO);

        // Get all the espacioLibreList where tarifa5hMiembro less than or equals to UPDATED_TARIFA_5_H_MIEMBRO
    ...
    public void getAllEspacioLibresByTarifa6hMiembroIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa6hMiembro greater than or equals to DEFAULT_TARIFA_6_H_MIEMBRO
        defaultEspacioLibreShouldBeFound("tarifa6hMiembro.greaterOrEqualThan=" + DEFAULT_TARIFA_6_H_MIEMBRO);

        // Get all the espacioLibreList where tarifa6hMiembro greater than or equals to UPDATED_TARIFA_6_H_MIEMBRO
        defaultEspacioLibreShouldNotBeFound("tarifa6hMiembro.greaterOrEqualThan=" + UPDATED_TARIFA_6_H_MIEMBRO);
    }
    ...
    public void getAllEspacioLibresByTarifa6hMiembroIsLessThanSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa6hMiembro less than or equals to DEFAULT_TARIFA_6_H_MIEMBRO
        defaultEspacioLibreShouldNotBeFound("tarifa6hMiembro.lessThan=" + DEFAULT_TARIFA_6_H_MIEMBRO);

        // Get all the espacioLibreList where tarifa6hMiembro less than or equals to UPDATED_TARIFA_6_H_MIEMBRO
    ...
    public void getAllEspacioLibresByTarifa7hMiembroIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa7hMiembro greater than or equals to DEFAULT_TARIFA_7_H_MIEMBRO
        defaultEspacioLibreShouldBeFound("tarifa7hMiembro.greaterOrEqualThan=" + DEFAULT_TARIFA_7_H_MIEMBRO);

        // Get all the espacioLibreList where tarifa7hMiembro greater than or equals to UPDATED_TARIFA_7_H_MIEMBRO
        defaultEspacioLibreShouldNotBeFound("tarifa7hMiembro.greaterOrEqualThan=" + UPDATED_TARIFA_7_H_MIEMBRO);
    }
    ...
    public void getAllEspacioLibresByTarifa7hMiembroIsLessThanSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa7hMiembro less than or equals to DEFAULT_TARIFA_7_H_MIEMBRO
        defaultEspacioLibreShouldNotBeFound("tarifa7hMiembro.lessThan=" + DEFAULT_TARIFA_7_H_MIEMBRO);

        // Get all the espacioLibreList where tarifa7hMiembro less than or equals to UPDATED_TARIFA_7_H_MIEMBRO
    ...
    public void getAllEspacioLibresByTarifa8hMiembroIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa8hMiembro greater than or equals to DEFAULT_TARIFA_8_H_MIEMBRO
        defaultEspacioLibreShouldBeFound("tarifa8hMiembro.greaterOrEqualThan=" + DEFAULT_TARIFA_8_H_MIEMBRO);

        // Get all the espacioLibreList where tarifa8hMiembro greater than or equals to UPDATED_TARIFA_8_H_MIEMBRO
        defaultEspacioLibreShouldNotBeFound("tarifa8hMiembro.greaterOrEqualThan=" + UPDATED_TARIFA_8_H_MIEMBRO);
    }
    ...
    public void getAllEspacioLibresByTarifa8hMiembroIsLessThanSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa8hMiembro less than or equals to DEFAULT_TARIFA_8_H_MIEMBRO
        defaultEspacioLibreShouldNotBeFound("tarifa8hMiembro.lessThan=" + DEFAULT_TARIFA_8_H_MIEMBRO);

        // Get all the espacioLibreList where tarifa8hMiembro less than or equals to UPDATED_TARIFA_8_H_MIEMBRO
    ...
    public void getAllEspacioLibresByTarifa1hInvitadoIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa1hInvitado greater than or equals to DEFAULT_TARIFA_1_H_INVITADO
        defaultEspacioLibreShouldBeFound("tarifa1hInvitado.greaterOrEqualThan=" + DEFAULT_TARIFA_1_H_INVITADO);

        // Get all the espacioLibreList where tarifa1hInvitado greater than or equals to UPDATED_TARIFA_1_H_INVITADO
        defaultEspacioLibreShouldNotBeFound("tarifa1hInvitado.greaterOrEqualThan=" + UPDATED_TARIFA_1_H_INVITADO);
    }
    ...
    public void getAllEspacioLibresByTarifa1hInvitadoIsLessThanSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa1hInvitado less than or equals to DEFAULT_TARIFA_1_H_INVITADO
        defaultEspacioLibreShouldNotBeFound("tarifa1hInvitado.lessThan=" + DEFAULT_TARIFA_1_H_INVITADO);

        // Get all the espacioLibreList where tarifa1hInvitado less than or equals to UPDATED_TARIFA_1_H_INVITADO
    ...
    public void getAllEspacioLibresByTarifa2hInvitadoIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa2hInvitado greater than or equals to DEFAULT_TARIFA_2_H_INVITADO
        defaultEspacioLibreShouldBeFound("tarifa2hInvitado.greaterOrEqualThan=" + DEFAULT_TARIFA_2_H_INVITADO);

        // Get all the espacioLibreList where tarifa2hInvitado greater than or equals to UPDATED_TARIFA_2_H_INVITADO
        defaultEspacioLibreShouldNotBeFound("tarifa2hInvitado.greaterOrEqualThan=" + UPDATED_TARIFA_2_H_INVITADO);
    }
    ...
    public void getAllEspacioLibresByTarifa2hInvitadoIsLessThanSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa2hInvitado less than or equals to DEFAULT_TARIFA_2_H_INVITADO
        defaultEspacioLibreShouldNotBeFound("tarifa2hInvitado.lessThan=" + DEFAULT_TARIFA_2_H_INVITADO);

        // Get all the espacioLibreList where tarifa2hInvitado less than or equals to UPDATED_TARIFA_2_H_INVITADO
    ...
    public void getAllEspacioLibresByTarifa3hInvitadoIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa3hInvitado greater than or equals to DEFAULT_TARIFA_3_H_INVITADO
        defaultEspacioLibreShouldBeFound("tarifa3hInvitado.greaterOrEqualThan=" + DEFAULT_TARIFA_3_H_INVITADO);

        // Get all the espacioLibreList where tarifa3hInvitado greater than or equals to UPDATED_TARIFA_3_H_INVITADO
        defaultEspacioLibreShouldNotBeFound("tarifa3hInvitado.greaterOrEqualThan=" + UPDATED_TARIFA_3_H_INVITADO);
    }
    ...
    public void getAllEspacioLibresByTarifa3hInvitadoIsLessThanSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa3hInvitado less than or equals to DEFAULT_TARIFA_3_H_INVITADO
        defaultEspacioLibreShouldNotBeFound("tarifa3hInvitado.lessThan=" + DEFAULT_TARIFA_3_H_INVITADO);

        // Get all the espacioLibreList where tarifa3hInvitado less than or equals to UPDATED_TARIFA_3_H_INVITADO
    ...
    public void getAllEspacioLibresByTarifa4hInvitadoIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa4hInvitado greater than or equals to DEFAULT_TARIFA_4_H_INVITADO
        defaultEspacioLibreShouldBeFound("tarifa4hInvitado.greaterOrEqualThan=" + DEFAULT_TARIFA_4_H_INVITADO);

        // Get all the espacioLibreList where tarifa4hInvitado greater than or equals to UPDATED_TARIFA_4_H_INVITADO
        defaultEspacioLibreShouldNotBeFound("tarifa4hInvitado.greaterOrEqualThan=" + UPDATED_TARIFA_4_H_INVITADO);
    }
    ...
    public void getAllEspacioLibresByTarifa4hInvitadoIsLessThanSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa4hInvitado less than or equals to DEFAULT_TARIFA_4_H_INVITADO
        defaultEspacioLibreShouldNotBeFound("tarifa4hInvitado.lessThan=" + DEFAULT_TARIFA_4_H_INVITADO);

        // Get all the espacioLibreList where tarifa4hInvitado less than or equals to UPDATED_TARIFA_4_H_INVITADO
    ...
    public void getAllEspacioLibresByTarifa5hInvitadoIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa5hInvitado greater than or equals to DEFAULT_TARIFA_5_H_INVITADO
        defaultEspacioLibreShouldBeFound("tarifa5hInvitado.greaterOrEqualThan=" + DEFAULT_TARIFA_5_H_INVITADO);

        // Get all the espacioLibreList where tarifa5hInvitado greater than or equals to UPDATED_TARIFA_5_H_INVITADO
        defaultEspacioLibreShouldNotBeFound("tarifa5hInvitado.greaterOrEqualThan=" + UPDATED_TARIFA_5_H_INVITADO);
    }
    ...
    public void getAllEspacioLibresByTarifa5hInvitadoIsLessThanSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa5hInvitado less than or equals to DEFAULT_TARIFA_5_H_INVITADO
        defaultEspacioLibreShouldNotBeFound("tarifa5hInvitado.lessThan=" + DEFAULT_TARIFA_5_H_INVITADO);

        // Get all the espacioLibreList where tarifa5hInvitado less than or equals to UPDATED_TARIFA_5_H_INVITADO
    ...
    public void getAllEspacioLibresByTarifa6hInvitadoIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa6hInvitado greater than or equals to DEFAULT_TARIFA_6_H_INVITADO
        defaultEspacioLibreShouldBeFound("tarifa6hInvitado.greaterOrEqualThan=" + DEFAULT_TARIFA_6_H_INVITADO);

        // Get all the espacioLibreList where tarifa6hInvitado greater than or equals to UPDATED_TARIFA_6_H_INVITADO
        defaultEspacioLibreShouldNotBeFound("tarifa6hInvitado.greaterOrEqualThan=" + UPDATED_TARIFA_6_H_INVITADO);
    }
    ...
    public void getAllEspacioLibresByTarifa6hInvitadoIsLessThanSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa6hInvitado less than or equals to DEFAULT_TARIFA_6_H_INVITADO
        defaultEspacioLibreShouldNotBeFound("tarifa6hInvitado.lessThan=" + DEFAULT_TARIFA_6_H_INVITADO);

        // Get all the espacioLibreList where tarifa6hInvitado less than or equals to UPDATED_TARIFA_6_H_INVITADO
    ...
    public void getAllEspacioLibresByTarifa7hInvitadoIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa7hInvitado greater than or equals to DEFAULT_TARIFA_7_H_INVITADO
        defaultEspacioLibreShouldBeFound("tarifa7hInvitado.greaterOrEqualThan=" + DEFAULT_TARIFA_7_H_INVITADO);

        // Get all the espacioLibreList where tarifa7hInvitado greater than or equals to UPDATED_TARIFA_7_H_INVITADO
        defaultEspacioLibreShouldNotBeFound("tarifa7hInvitado.greaterOrEqualThan=" + UPDATED_TARIFA_7_H_INVITADO);
    }
    ...
    public void getAllEspacioLibresByTarifa7hInvitadoIsLessThanSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa7hInvitado less than or equals to DEFAULT_TARIFA_7_H_INVITADO
        defaultEspacioLibreShouldNotBeFound("tarifa7hInvitado.lessThan=" + DEFAULT_TARIFA_7_H_INVITADO);

        // Get all the espacioLibreList where tarifa7hInvitado less than or equals to UPDATED_TARIFA_7_H_INVITADO
    ...
    public void getAllEspacioLibresByTarifa8hInvitadoIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa8hInvitado greater than or equals to DEFAULT_TARIFA_8_H_INVITADO
        defaultEspacioLibreShouldBeFound("tarifa8hInvitado.greaterOrEqualThan=" + DEFAULT_TARIFA_8_H_INVITADO);

        // Get all the espacioLibreList where tarifa8hInvitado greater than or equals to UPDATED_TARIFA_8_H_INVITADO
        defaultEspacioLibreShouldNotBeFound("tarifa8hInvitado.greaterOrEqualThan=" + UPDATED_TARIFA_8_H_INVITADO);
    }
    ...
    public void getAllEspacioLibresByTarifa8hInvitadoIsLessThanSomething() throws Exception {
        ...
        // Get all the espacioLibreList where tarifa8hInvitado less than or equals to DEFAULT_TARIFA_8_H_INVITADO
        defaultEspacioLibreShouldNotBeFound("tarifa8hInvitado.lessThan=" + DEFAULT_TARIFA_8_H_INVITADO);

        // Get all the espacioLibreList where tarifa8hInvitado less than or equals to UPDATED_TARIFA_8_H_INVITADO
