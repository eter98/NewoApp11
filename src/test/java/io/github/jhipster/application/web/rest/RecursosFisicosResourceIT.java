...
public class RecursosFisicosResourceIT {
     ...
     *
     * @see io.github.jhipster.application.repository.search.RecursosFisicosSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllRecursosFisicosByValorUnitarioIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valorUnitario greater than or equals to DEFAULT_VALOR_UNITARIO
        defaultRecursosFisicosShouldBeFound("valorUnitario.greaterOrEqualThan=" + DEFAULT_VALOR_UNITARIO);

        // Get all the recursosFisicosList where valorUnitario greater than or equals to UPDATED_VALOR_UNITARIO
        defaultRecursosFisicosShouldNotBeFound("valorUnitario.greaterOrEqualThan=" + UPDATED_VALOR_UNITARIO);
    }
    ...
    public void getAllRecursosFisicosByValorUnitarioIsLessThanSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valorUnitario less than or equals to DEFAULT_VALOR_UNITARIO
        defaultRecursosFisicosShouldNotBeFound("valorUnitario.lessThan=" + DEFAULT_VALOR_UNITARIO);

        // Get all the recursosFisicosList where valorUnitario less than or equals to UPDATED_VALOR_UNITARIO
    ...
    public void getAllRecursosFisicosByValor1HIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor1H greater than or equals to DEFAULT_VALOR_1_H
        defaultRecursosFisicosShouldBeFound("valor1H.greaterOrEqualThan=" + DEFAULT_VALOR_1_H);

        // Get all the recursosFisicosList where valor1H greater than or equals to UPDATED_VALOR_1_H
        defaultRecursosFisicosShouldNotBeFound("valor1H.greaterOrEqualThan=" + UPDATED_VALOR_1_H);
    }
    ...
    public void getAllRecursosFisicosByValor1HIsLessThanSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor1H less than or equals to DEFAULT_VALOR_1_H
        defaultRecursosFisicosShouldNotBeFound("valor1H.lessThan=" + DEFAULT_VALOR_1_H);

        // Get all the recursosFisicosList where valor1H less than or equals to UPDATED_VALOR_1_H
    ...
    public void getAllRecursosFisicosByValor2HIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor2H greater than or equals to DEFAULT_VALOR_2_H
        defaultRecursosFisicosShouldBeFound("valor2H.greaterOrEqualThan=" + DEFAULT_VALOR_2_H);

        // Get all the recursosFisicosList where valor2H greater than or equals to UPDATED_VALOR_2_H
        defaultRecursosFisicosShouldNotBeFound("valor2H.greaterOrEqualThan=" + UPDATED_VALOR_2_H);
    }
    ...
    public void getAllRecursosFisicosByValor2HIsLessThanSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor2H less than or equals to DEFAULT_VALOR_2_H
        defaultRecursosFisicosShouldNotBeFound("valor2H.lessThan=" + DEFAULT_VALOR_2_H);

        // Get all the recursosFisicosList where valor2H less than or equals to UPDATED_VALOR_2_H
    ...
    public void getAllRecursosFisicosByValor3HIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor3H greater than or equals to DEFAULT_VALOR_3_H
        defaultRecursosFisicosShouldBeFound("valor3H.greaterOrEqualThan=" + DEFAULT_VALOR_3_H);

        // Get all the recursosFisicosList where valor3H greater than or equals to UPDATED_VALOR_3_H
        defaultRecursosFisicosShouldNotBeFound("valor3H.greaterOrEqualThan=" + UPDATED_VALOR_3_H);
    }
    ...
    public void getAllRecursosFisicosByValor3HIsLessThanSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor3H less than or equals to DEFAULT_VALOR_3_H
        defaultRecursosFisicosShouldNotBeFound("valor3H.lessThan=" + DEFAULT_VALOR_3_H);

        // Get all the recursosFisicosList where valor3H less than or equals to UPDATED_VALOR_3_H
    ...
    public void getAllRecursosFisicosByValor4HIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor4H greater than or equals to DEFAULT_VALOR_4_H
        defaultRecursosFisicosShouldBeFound("valor4H.greaterOrEqualThan=" + DEFAULT_VALOR_4_H);

        // Get all the recursosFisicosList where valor4H greater than or equals to UPDATED_VALOR_4_H
        defaultRecursosFisicosShouldNotBeFound("valor4H.greaterOrEqualThan=" + UPDATED_VALOR_4_H);
    }
    ...
    public void getAllRecursosFisicosByValor4HIsLessThanSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor4H less than or equals to DEFAULT_VALOR_4_H
        defaultRecursosFisicosShouldNotBeFound("valor4H.lessThan=" + DEFAULT_VALOR_4_H);

        // Get all the recursosFisicosList where valor4H less than or equals to UPDATED_VALOR_4_H
    ...
    public void getAllRecursosFisicosByValor5HIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor5H greater than or equals to DEFAULT_VALOR_5_H
        defaultRecursosFisicosShouldBeFound("valor5H.greaterOrEqualThan=" + DEFAULT_VALOR_5_H);

        // Get all the recursosFisicosList where valor5H greater than or equals to UPDATED_VALOR_5_H
        defaultRecursosFisicosShouldNotBeFound("valor5H.greaterOrEqualThan=" + UPDATED_VALOR_5_H);
    }
    ...
    public void getAllRecursosFisicosByValor5HIsLessThanSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor5H less than or equals to DEFAULT_VALOR_5_H
        defaultRecursosFisicosShouldNotBeFound("valor5H.lessThan=" + DEFAULT_VALOR_5_H);

        // Get all the recursosFisicosList where valor5H less than or equals to UPDATED_VALOR_5_H
    ...
    public void getAllRecursosFisicosByValor6HIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor6H greater than or equals to DEFAULT_VALOR_6_H
        defaultRecursosFisicosShouldBeFound("valor6H.greaterOrEqualThan=" + DEFAULT_VALOR_6_H);

        // Get all the recursosFisicosList where valor6H greater than or equals to UPDATED_VALOR_6_H
        defaultRecursosFisicosShouldNotBeFound("valor6H.greaterOrEqualThan=" + UPDATED_VALOR_6_H);
    }
    ...
    public void getAllRecursosFisicosByValor6HIsLessThanSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor6H less than or equals to DEFAULT_VALOR_6_H
        defaultRecursosFisicosShouldNotBeFound("valor6H.lessThan=" + DEFAULT_VALOR_6_H);

        // Get all the recursosFisicosList where valor6H less than or equals to UPDATED_VALOR_6_H
    ...
    public void getAllRecursosFisicosByValor7HIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor7H greater than or equals to DEFAULT_VALOR_7_H
        defaultRecursosFisicosShouldBeFound("valor7H.greaterOrEqualThan=" + DEFAULT_VALOR_7_H);

        // Get all the recursosFisicosList where valor7H greater than or equals to UPDATED_VALOR_7_H
        defaultRecursosFisicosShouldNotBeFound("valor7H.greaterOrEqualThan=" + UPDATED_VALOR_7_H);
    }
    ...
    public void getAllRecursosFisicosByValor7HIsLessThanSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor7H less than or equals to DEFAULT_VALOR_7_H
        defaultRecursosFisicosShouldNotBeFound("valor7H.lessThan=" + DEFAULT_VALOR_7_H);

        // Get all the recursosFisicosList where valor7H less than or equals to UPDATED_VALOR_7_H
    ...
    public void getAllRecursosFisicosByValor8HIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor8H greater than or equals to DEFAULT_VALOR_8_H
        defaultRecursosFisicosShouldBeFound("valor8H.greaterOrEqualThan=" + DEFAULT_VALOR_8_H);

        // Get all the recursosFisicosList where valor8H greater than or equals to UPDATED_VALOR_8_H
        defaultRecursosFisicosShouldNotBeFound("valor8H.greaterOrEqualThan=" + UPDATED_VALOR_8_H);
    }
    ...
    public void getAllRecursosFisicosByValor8HIsLessThanSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor8H less than or equals to DEFAULT_VALOR_8_H
        defaultRecursosFisicosShouldNotBeFound("valor8H.lessThan=" + DEFAULT_VALOR_8_H);

        // Get all the recursosFisicosList where valor8H less than or equals to UPDATED_VALOR_8_H
    ...
    public void getAllRecursosFisicosByValor9HIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor9H greater than or equals to DEFAULT_VALOR_9_H
        defaultRecursosFisicosShouldBeFound("valor9H.greaterOrEqualThan=" + DEFAULT_VALOR_9_H);

        // Get all the recursosFisicosList where valor9H greater than or equals to UPDATED_VALOR_9_H
        defaultRecursosFisicosShouldNotBeFound("valor9H.greaterOrEqualThan=" + UPDATED_VALOR_9_H);
    }
    ...
    public void getAllRecursosFisicosByValor9HIsLessThanSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor9H less than or equals to DEFAULT_VALOR_9_H
        defaultRecursosFisicosShouldNotBeFound("valor9H.lessThan=" + DEFAULT_VALOR_9_H);

        // Get all the recursosFisicosList where valor9H less than or equals to UPDATED_VALOR_9_H
    ...
    public void getAllRecursosFisicosByValor10HIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor10H greater than or equals to DEFAULT_VALOR_10_H
        defaultRecursosFisicosShouldBeFound("valor10H.greaterOrEqualThan=" + DEFAULT_VALOR_10_H);

        // Get all the recursosFisicosList where valor10H greater than or equals to UPDATED_VALOR_10_H
        defaultRecursosFisicosShouldNotBeFound("valor10H.greaterOrEqualThan=" + UPDATED_VALOR_10_H);
    }
    ...
    public void getAllRecursosFisicosByValor10HIsLessThanSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor10H less than or equals to DEFAULT_VALOR_10_H
        defaultRecursosFisicosShouldNotBeFound("valor10H.lessThan=" + DEFAULT_VALOR_10_H);

        // Get all the recursosFisicosList where valor10H less than or equals to UPDATED_VALOR_10_H
    ...
    public void getAllRecursosFisicosByValor11HIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor11H greater than or equals to DEFAULT_VALOR_11_H
        defaultRecursosFisicosShouldBeFound("valor11H.greaterOrEqualThan=" + DEFAULT_VALOR_11_H);

        // Get all the recursosFisicosList where valor11H greater than or equals to UPDATED_VALOR_11_H
        defaultRecursosFisicosShouldNotBeFound("valor11H.greaterOrEqualThan=" + UPDATED_VALOR_11_H);
    }
    ...
    public void getAllRecursosFisicosByValor11HIsLessThanSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor11H less than or equals to DEFAULT_VALOR_11_H
        defaultRecursosFisicosShouldNotBeFound("valor11H.lessThan=" + DEFAULT_VALOR_11_H);

        // Get all the recursosFisicosList where valor11H less than or equals to UPDATED_VALOR_11_H
    ...
    public void getAllRecursosFisicosByValor12HIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor12H greater than or equals to DEFAULT_VALOR_12_H
        defaultRecursosFisicosShouldBeFound("valor12H.greaterOrEqualThan=" + DEFAULT_VALOR_12_H);

        // Get all the recursosFisicosList where valor12H greater than or equals to UPDATED_VALOR_12_H
        defaultRecursosFisicosShouldNotBeFound("valor12H.greaterOrEqualThan=" + UPDATED_VALOR_12_H);
    }
    ...
    public void getAllRecursosFisicosByValor12HIsLessThanSomething() throws Exception {
        ...
        // Get all the recursosFisicosList where valor12H less than or equals to DEFAULT_VALOR_12_H
        defaultRecursosFisicosShouldNotBeFound("valor12H.lessThan=" + DEFAULT_VALOR_12_H);

        // Get all the recursosFisicosList where valor12H less than or equals to UPDATED_VALOR_12_H
