...
public class MiembrosResourceIT {
     ...
     *
     * @see io.github.jhipster.application.repository.search.MiembrosSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void checkFechaRegistroIsRequired() throws Exception {
        int databaseSizeBeforeTest = miembrosRepository.findAll().size();
        // set the field null
        miembros.setFechaRegistro(null);
    ...
    public void getAllMiembrosByIdentificacionIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the miembrosList where identificacion greater than or equals to DEFAULT_IDENTIFICACION
        defaultMiembrosShouldBeFound("identificacion.greaterOrEqualThan=" + DEFAULT_IDENTIFICACION);

        // Get all the miembrosList where identificacion greater than or equals to UPDATED_IDENTIFICACION
        defaultMiembrosShouldNotBeFound("identificacion.greaterOrEqualThan=" + UPDATED_IDENTIFICACION);
    }
    ...
    public void getAllMiembrosByIdentificacionIsLessThanSomething() throws Exception {
        ...
        // Get all the miembrosList where identificacion less than or equals to DEFAULT_IDENTIFICACION
        defaultMiembrosShouldNotBeFound("identificacion.lessThan=" + DEFAULT_IDENTIFICACION);

        // Get all the miembrosList where identificacion less than or equals to UPDATED_IDENTIFICACION
    ...
    public void getAllMiembrosByFechaNacimientoIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the miembrosList where fechaNacimiento greater than or equals to DEFAULT_FECHA_NACIMIENTO
        defaultMiembrosShouldBeFound("fechaNacimiento.greaterOrEqualThan=" + DEFAULT_FECHA_NACIMIENTO);

        // Get all the miembrosList where fechaNacimiento greater than or equals to UPDATED_FECHA_NACIMIENTO
        defaultMiembrosShouldNotBeFound("fechaNacimiento.greaterOrEqualThan=" + UPDATED_FECHA_NACIMIENTO);
    }
    ...
    public void getAllMiembrosByFechaNacimientoIsLessThanSomething() throws Exception {
        ...
        // Get all the miembrosList where fechaNacimiento less than or equals to DEFAULT_FECHA_NACIMIENTO
        defaultMiembrosShouldNotBeFound("fechaNacimiento.lessThan=" + DEFAULT_FECHA_NACIMIENTO);

        // Get all the miembrosList where fechaNacimiento less than or equals to UPDATED_FECHA_NACIMIENTO
    ...
    @Test
    @Transactional
    public void getAllMiembrosByFechaRegistroIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        miembrosRepository.saveAndFlush(miembros);

        // Get all the miembrosList where fechaRegistro greater than or equals to DEFAULT_FECHA_REGISTRO
        defaultMiembrosShouldBeFound("fechaRegistro.greaterOrEqualThan=" + DEFAULT_FECHA_REGISTRO);

        // Get all the miembrosList where fechaRegistro greater than or equals to UPDATED_FECHA_REGISTRO
        defaultMiembrosShouldNotBeFound("fechaRegistro.greaterOrEqualThan=" + UPDATED_FECHA_REGISTRO);
    }

    @Test
    @Transactional
    public void getAllMiembrosByFechaRegistroIsLessThanSomething() throws Exception {
        // Initialize the database
        miembrosRepository.saveAndFlush(miembros);

        // Get all the miembrosList where fechaRegistro less than or equals to DEFAULT_FECHA_REGISTRO
        defaultMiembrosShouldNotBeFound("fechaRegistro.lessThan=" + DEFAULT_FECHA_REGISTRO);

        // Get all the miembrosList where fechaRegistro less than or equals to UPDATED_FECHA_REGISTRO
        defaultMiembrosShouldBeFound("fechaRegistro.lessThan=" + UPDATED_FECHA_REGISTRO);
    }
    ...
    @Test
    @Transactional
    public void getAllMiembrosBySedeIsEqualToSomething() throws Exception {
        // Initialize the database
        Sedes sede = SedesResourceIT.createEntity(em);
        em.persist(sede);
        em.flush();
        miembros.setSede(sede);
        miembrosRepository.saveAndFlush(miembros);
        Long sedeId = sede.getId();

        // Get all the miembrosList where sede equals to sedeId
        defaultMiembrosShouldBeFound("sedeId.equals=" + sedeId);

        // Get all the miembrosList where sede equals to sedeId + 1
        defaultMiembrosShouldNotBeFound("sedeId.equals=" + (sedeId + 1));
    }
