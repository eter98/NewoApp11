...
import { ChatGrupoComponent } from 'app/entities/chat-grupo/chat-grupo.component';
...
describe('Component Tests', () => {
  describe('ChatGrupo Management Component', () => {
    let comp: ChatGrupoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ChatGrupoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.chatGrupos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
